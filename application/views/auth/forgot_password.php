          ...
          <div class="col-12 col-md-8 h-100 bg-white">
            <div class="auto-form-wrapper d-flex align-items-center justify-content-center flex-column">
              <div class="nav-get-started" >
                <p>Have an account ?</p>
                <a class="btn get-started-btn" href="login" style="border:solid 1px gray;color:gray;">LOGIN HERE</a>
              </div>
              <?php echo form_open("auth/forgot_password");?>
                <p><img src="<?php echo base_url(); ?>assets/img/small.png"></p>
                <h3 class="mr-auto"><?php echo lang('forgot_password_heading');?></h3>
                ...
                <div class="form-group">
                  <button class="btn btn-dark pull-right" type="submit">SEND EMAIL</button>
                </div>
