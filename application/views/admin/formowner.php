<?php
if($this->uri->segment(2) == "edtdanaowner"){
    $title = "Edit data trasnfer dana dari owner";
    $form = "uptdanaowner";
}else{
    $title = "Tambah data transfer dana dari owner";
    $form = "savedanaowner";
}
?>
<!-- top tiles -->
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>home/<?php echo $form; ?>">   
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nama" value="<?php echo $view->namaowner; ?>" name="nama" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <?php echo anchor('home/tfowner/'.$kunci,'Cancel',['class'=>'btn btn-danger']); ?>
