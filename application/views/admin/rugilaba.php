                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      ...
                      <li><a href="<?php echo base_url(); ?>home/rugilaba/<?php echo $rmah->id_perumahan; ?>"><?php echo $no."."; ?> &nbsp;<?php echo $rmah->nama_perumahan; ?></a></li>
                        <?php $no++; } ?>
                    </ul>
                    </div>
                      </li>
...
<?php                               $luar = $keluar->row();
                                    ...
                                    $hj = $harjual->row();
                                    $bk = $bookfee->row();
                                    $real = $cs->totalcsatu + $cd->totalcdua + $ct->totalctiga +$ce->totalcempat;
                                    $utang = $hj->totaljual - ($cs->totalcsatu + $cd->totalcdua + $ct->totalctiga +$ce->totalcempat + $bk->totalbook); ?>
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                      ...
                      <tbody>
                          <tr>
                              ...
                              <td>
                                  ...
                                  echo"Rp. ".number_format(($cs->totalcsatu + $cd->totalcdua + $ct->totalctiga +$ce->totalcempat),0,',','.'); ?>
                              </td>
                          ...
                          <tr>
                              ...
                              <td>
                                  <?php 
                                  echo"Rp. ".number_format(($hj->totaljual - ($cs->totalcsatu + $cd->totalcdua + $ct->totalctiga +$ce->totalcempat + $bk->totalbook)),0,',','.'); ?>
                              </td>
                              <td></td>
                          </tr>
