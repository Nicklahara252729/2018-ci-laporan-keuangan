...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Detail dana yang ditransfer dari investor<small><?php echo $hell; ?></small></h2>
                          ...
                          <?php $no=1; foreach($view as $dt){ ?>
                            <tr>
                                ...
                                <td style="width:150px;">
                                    <center>
                                    <a href="<?php echo base_url(); ?>home/edtdanainvestor/<?php echo $this->uri->segment(3); ?>/<?php echo $dt->id_danainvestor; ?>" class="btn btn-sm btn-warning">Edit</a>
                                    
                                    <a href="<?php echo base_url(); ?>home/deldanainvestor/<?php echo $dt->id_danainvestor; ?>/<?php echo $this->uri->segment(3); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?');">Hapus</a>
                                    </center>
                                </td>
                            </tr>
                          <?php $no++; } ?>
